...
class YAMLConfig(BaseConfig):
    def __init__(self, cfg_path: str, **kwargs) -> None:
        ...
        self.config_path = cfg_path  # Store original config path
        ...
        for k in super().__dict__:
            ...
            elif k == 'epochs' and 'epoches' in cfg:
                self.epochs = cfg['epoches']
        self._amp_dtype_str = str(cfg.get("amp_dtype", "float16")).lower()
    ...
    def scaler(
        ...
        if self._scaler is None and self.yaml_cfg.get("use_amp", False) and self._amp_dtype_str != "bfloat16":
    ...
    def evaluator(
        ...
        implementedEvaluators = ["CocoEvaluator", "CocoEvaluatorSlow", "AitodCocoEvaluator", "AitodCocoEvaluatorSlow", "VisdroneCocoEvaluator", "AitodCocoFasterEvaluator"]
