...
class RunRecorder:
    ...
    Usage::
        ...
        for frame_id, frame in frames:
            ...
            recorder.add_tracks(frame_id, tracks, min_box_area)
            recorder.write_video_frame(frame, tracks, frame_id, min_box_area)
    ...
    def add_tracks(
        ...
        Args:
            ...
            min_box_area:   Skip tracks smaller than this (width * height).
        """
    ...
    def write_video_frame(
        ...
        if self._video_writer is None:
            ...
            logger.info("Video writer opened: %s (%dx%d @ %.1f fps)",
                         video_path, w, h, self._video_fps)
    ...
    def save(self) -> None:
        """Write ``detections.csv``, ``tracks.csv``, and release the video."""
